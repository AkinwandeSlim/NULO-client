...
const getCardClass = (theme: "dark" | "light") =>
  `rounded-xl border ${theme === "dark" ? "border-white/5 bg-[#0A0A0A]" : "border-slate-200 bg-white"}`
const getCardHoverClass = () =>
  "transition-all duration-300 hover:-translate-y-1 hover:border-orange-500/30"
const BTN_PRIMARY =
  "rounded-none border border-orange-500 bg-orange-500 text-black transition-colors hover:bg-white hover:text-black"
const BTN_OUTLINE =
  "rounded-none border border-orange-500 bg-transparent text-orange-400 transition-colors hover:bg-orange-500 hover:text-black"
    ...
    <div className={`flex min-h-screen flex-col font-sans antialiased ${theme === "dark" ? "text-white bg-black" : "text-slate-900 bg-white"}`}>
            ...
            <div className="grid items-stretch gap-5 sm:gap-8 md:grid-cols-3">
              {VALUE_CARDS.map((v, index) => (
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: index * 0.1, ease: "easeOut" }}
                >
                  <div className={cx(getCardClass(theme), getCardHoverClass(), "flex h-full flex-col p-6 lg:p-8")}>
                    <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-full bg-orange-500/10">
                      <v.icon className="h-6 w-6 text-orange-400" />
                    </div>
                    <h3 className={`mb-3 text-lg font-semibold ${theme === "dark" ? "text-white" : "text-slate-900"}`}>{v.title}</h3>
                    <p className={`text-[15px] leading-relaxed ${theme === "dark" ? "text-white/50" : "text-slate-600"}`}>{v.body}</p>
                  </div>
                </motion.div>
              ))}
            </div>
              ...
              {STEPS.map((s, index) => (
                ...
                >
                  {index < STEPS.length - 1 && (
                    <div className="hidden lg:block absolute top-8 left-[calc(50%+2rem)] w-[calc(100%-4rem)] h-px border-t border-dashed border-orange-500/30" />
                  )}
                  <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-orange-500 text-2xl font-semibold text-orange-400">
                    {s.num}
                  </div>
                  <h3 className={`mb-3 mt-5 text-lg font-semibold ${theme === "dark" ? "text-white" : "text-slate-900"}`}>{s.title}</h3>
                  <p className={`text-[15px] leading-relaxed ${theme === "dark" ? "text-white/50" : "text-slate-600"}`}>{s.body}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="text-center lg:text-left">
                ...
                <h2 className="mb-4 text-[28px] font-semibold sm:text-[32px] lg:text-[38px]">
                  Co-Own <span className="nulo-gradient-text">High-Yield</span> Rental Properties
                </h2>
                <p className={`mx-auto mb-8 max-w-xl text-[15px] leading-relaxed ${theme === "dark" ? "text-white/70" : "text-slate-800"} lg:mx-0`}>
                ...
                <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center lg:justify-start">
                  <Link href={WAITLIST_URL}>
                    <Button className={cx(BTN_PRIMARY, "group px-8 py-6 text-sm font-medium")}>
                  ...
                  <a
                    ...
                    className={`inline-flex items-center gap-2 text-sm font-medium text-orange-400 transition-colors ${theme === "dark" ? "hover:text-white" : "hover:text-orange-600"}`}
                  >
        ...
        <Section id="ceo" variant="gradient-light" glow theme={theme}>
          ...
          >
            <div>
              ...
              <div className={`space-y-4 text-[15px] leading-relaxed ${theme === "dark" ? "text-white/70" : "text-slate-700"}`}>
                <p>
              ...
              <div className="mt-8">
                <div className={`font-semibold ${theme === "dark" ? "text-white" : "text-slate-900"}`}>Terver Orbunde (MBA)</div>
                <div className="text-sm text-orange-400">
                  Founder &amp; Chief Executive Officer, Nulo Africa
                </div>
              </div>
            </div>

            <div className="lg:sticky lg:top-28">
              <div className="relative aspect-square overflow-hidden rounded-2xl border border-orange-500/20">
                <img
                  src="/images/ceo.jpg"
                  alt="Terver Orbunde - CEO"
            ...
            <div className="mx-auto grid max-w-3xl items-stretch gap-6 sm:grid-cols-2">
              {FOUNDERS.map((founder, index) => (
                ...
                <div className="flex flex-1 flex-col p-6 lg:p-8">
                  <h3 className={`mb-1 text-lg font-semibold ${theme === "dark" ? "text-white" : "text-slate-900"}`}>{founder.name}</h3>
                  <p className="mb-3 text-sm font-medium text-orange-400">{founder.role}</p>
                  <p className={`text-[15px] leading-relaxed ${theme === "dark" ? "text-white/50" : "text-slate-600"}`}>{founder.bio}</p>
                </div>
                </motion.div>
            ))}
          </div>
          ...
          >
            ...
            >
              {TESTIMONIALS.map((t) => (
                <div
                  key={t.author}
                  className={cx(getCardClass(theme), "flex w-[340px] flex-shrink-0 snap-start flex-col p-6")}
                >
                  <Quote className="mb-4 h-8 w-8 text-orange-500/30" />
                  <p className={`mb-6 flex-1 text-[15px] leading-relaxed ${theme === "dark" ? "text-white/70" : "text-slate-700"}`}>
                    &ldquo;{t.quote}&rdquo;
                  </p>
                  <div className={`text-sm font-medium ${theme === "dark" ? "text-white" : "text-slate-900"}`}>{t.author}</div>
                  <div className={`text-xs ${theme === "dark" ? "text-white/40" : "text-slate-500"}`}>{t.city}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        >
          ...
          <div>
            {FAQS.map((item, i) => {
              ...
              return (
                <div key={item.q} className={`border-b ${theme === "dark" ? "border-white/10" : "border-slate-200"}`}>
                  <button
                    type="button"
                    onClick={() => setOpenFaq(open ? null : i)}
                    className={`flex w-full items-center justify-between gap-4 py-5 text-left text-sm font-medium transition-colors hover:text-orange-400 ${theme === "dark" ? "text-white" : "text-slate-800"}`}
                    aria-expanded={open}
                  >
                    <span>{item.q}</span>
                    <ChevronDown
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className={`pb-5 text-[15px] leading-relaxed ${theme === "dark" ? "text-white/70" : "text-slate-700"}`}>{item.a}</p>
                    </div>
                  </div>
                </div>
              )
        ...
        <Section id="contact" variant="gradient-light" glow theme={theme}>
          ...
          >
            ...
            <form onSubmit={(e) => e.preventDefault()} className={cx(getCardClass(theme), "p-6 lg:p-8")}>
              <div className="mb-5">
                <label className={`mb-2 block text-[13px] font-medium ${theme === "dark" ? "text-white/70" : "text-slate-700"}`}>Name</label>
                <input
                  type="text"
                  placeholder="Your full name"
                  className={`w-full rounded-none border px-4 py-3 text-sm transition-colors duration-200 focus:border-orange-500 focus:outline-none ${theme === "dark" ? "border-white/10 bg-black text-white placeholder:text-white/30" : "border-slate-200 bg-white text-slate-900 placeholder:text-slate-400"}`}
                />
              </div>
              <div className="mb-5">
                <label className={`mb-2 block text-[13px] font-medium ${theme === "dark" ? "text-white/70" : "text-slate-700"}`}>Email</label>
                <input
                  type="email"
              ...
              <div className="mb-6">
                <label className={`mb-2 block text-[13px] font-medium ${theme === "dark" ? "text-white/70" : "text-slate-700"}`}>Message</label>
                <textarea
                  rows={5}
                  placeholder="Tell us how we can help…"
                  className={`w-full rounded-none border px-4 py-3 text-sm transition-colors duration-200 focus:border-orange-500 focus:outline-none resize-none ${theme === "dark" ? "border-white/10 bg-black text-white placeholder:text-white/30" : "border-slate-200 bg-white text-slate-900 placeholder:text-slate-400"}`}
                />
              </div>
              <Button type="submit" className={cx(BTN_PRIMARY, "w-full py-6 text-sm font-medium")}>
      ...
      {showTop && (
        <button
          ...
          className="fixed bottom-6 right-6 z-40 flex h-11 w-11 items-center justify-center rounded-full bg-orange-500 text-black shadow-lg shadow-orange-500/30 transition-all duration-300 hover:scale-110 hover:bg-white"
        >
...
function ProductCard({
  ...
  return (
    <div className={cx(getCardClass(theme), getCardHoverClass(), "group flex h-full flex-col border-t-2 border-t-transparent hover:border-t-orange-500 p-5 sm:p-6 lg:p-8 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/5")}>
      ...
      <p className="mb-2 text-[12px] font-medium uppercase tracking-[0.14em] text-orange-400/80">
        {tag}
      </p>
      <h3 className={`mb-3 text-lg font-semibold ${theme === "dark" ? "text-white" : "text-slate-900"}`}>{title}</h3>
      <p className={`mb-6 flex-1 text-[15px] leading-relaxed ${theme === "dark" ? "text-white/50" : "text-slate-600"}`}>{body}</p>
      <Link
        href={href}
        onClick={handleClick}
        className="inline-flex items-center text-sm font-medium text-orange-400 transition-colors hover:text-white"
      >
        {cta}
        <ChevronRight className="ml-1 h-4 w-4 transition-transform group-hover:translate-x-0.5" />
      </Link>
