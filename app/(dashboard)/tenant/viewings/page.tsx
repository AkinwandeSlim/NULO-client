  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        {/* ✅ FIX 6: "Pending" stat renamed to "Scheduled" */}
        <Card className="border-orange-200 bg-white/80 backdrop-blur-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
        ...
        <Card className="border-orange-200 bg-white/80 backdrop-blur-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-600">Visited</p>
...
//     // ✅ FIX 8: Show Apply Now for confirmed viewings AND completed viewings
//     // Tenant can apply at any point after scheduling — no need to wait for landlord confirmation
//     const showApplyNow = request.status === 'confirmed' || request.status === 'pending' || request.status === 'completed'
