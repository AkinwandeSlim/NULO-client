...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      {/* Back Button */}
      <Link href="/" className="absolute top-4 left-4 z-50 inline-flex items-center gap-2 px-3 py-2 text-sm text-slate-600 hover:text-orange-600 transition-colors duration-300 rounded-lg hover:bg-slate-100 cursor-pointer md:top-6 md:left-6 md:px-4 md:text-base">
